...
public class RCC_ProtectCameraFromWallClip : MonoBehaviour{
	...
	public float returnTime = 0f;                 // time taken to move back towards desired position, when not clipping (typically should be a higher value than clipMoveTime)
	...
	public float closestDistance = 0f;            // the closest distance the camera can be from the target
